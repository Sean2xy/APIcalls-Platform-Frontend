...
import teemoBackImg from '../../../../public/timo.jpg';
import logo from '../../../../public/teemo.jpg';
...
const Login: React.FC = () => {
  ...
  return (
    <div>
      ...
      >
        <LoginFormPage
          backgroundImageUrl={teemoBackImg}
          // logo="https://image-bed-ichensw.oss-cn-hangzhou.aliyuncs.com/logo.png"
          logo={logo}
          title="Teemo API"
          subTitle="The BEST API Interface Platform"
          initialValues={{
            autoLogin: true,
          }}
          ...
          {loginType === 'account' && (
            <>
              <ProFormText
                ...
                placeholder={'Default: monkishipa'}
                rules={[
                  {
                    required: true,
                    message: '用户名是必填项！',
